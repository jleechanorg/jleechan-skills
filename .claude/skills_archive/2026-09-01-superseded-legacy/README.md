# Superseded Legacy Skills Archive — 2026-09-01

This directory contains historical skill packages that have zero 30-day usage evidence, zero inbound graph references from active workflows, and have been superseded by modern unified frameworks.

## Archival Inventory

| Skill | Former Path | Superseded By / Rationale |
|---|---|---|
| `build-test-lint-autopilot` | `.claude/skills/build-test-lint-autopilot/` | Legacy Nov 2025 `worldarchitect.ai` test runner script wrapper; superseded by `4layer` and `harness-engineering`. |
