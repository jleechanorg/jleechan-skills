...
- This is a configuration/preflight check defect: there is no standalone `minimax` binary. MiniMax automation uses the `claude` CLI binary with MiniMax API environment variables.
